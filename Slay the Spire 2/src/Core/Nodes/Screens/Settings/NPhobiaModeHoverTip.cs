...
public partial class NPhobiaModeHoverTip : Control
{
	...
	public override void _Ready()
	{
		...
		_hoverTip = new HoverTip(new LocString("settings_ui", "PHOBIA_MODE"), new LocString("settings_ui", "PHOBIA_MODE_DESCRIPTION"));
	}
