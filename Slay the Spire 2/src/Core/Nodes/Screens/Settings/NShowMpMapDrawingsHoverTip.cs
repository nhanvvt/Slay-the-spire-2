...
public partial class NShowMpMapDrawingsHoverTip : Control
{
	...
	public override void _Ready()
	{
		...
		_hoverTip = new HoverTip(new LocString("settings_ui", "SHOW_MP_DRAWINGS_HEADER"), new LocString("settings_ui", "SHOW_MP_DRAWINGS_DESCRIPTION"));
	}
